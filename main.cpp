...
int main(){
    ...
    InitAudioDevice();
    move = LoadSound("C:\\Users\\eyuel\\Downloads\\1149930.audio-Games-Backgammon-Wood_Board-Placing_Pieces-Varied_11.wav");
    click = LoadSound("C:\\Users\\eyuel\\Downloads\\click-button-140881.mp3");
